...
# This script will map a single readset with Salmon.

DATA=$1
SAMPLE=$2 
#In the shell script execution, include the following
# First cmd line arg = name for overarching salmon file
# 2nd cmd line arg = name of sample
